<template>
  <section>
    <div class="panel search-panel">
      <el-form :model="query" inline class="search-form">
        <el-form-item label="标签名称">
          <el-input v-model="query.name" placeholder="请输入标签名称" clearable @keyup.enter="handleSearch" />
        </el-form-item>
        <el-form-item>
    ...
    <TagFormDialog v-model="dialogVisible" :row="editingRow" @submit="submitForm" />
  </section>
</template>
...
import TagFormDialog from './childComps/TagFormDialog.vue';
...
async function remove(row) {
  await ElMessageBox.confirm(`确定删除「${row.name}」吗？`, '删除标签', { type: 'warning' });
